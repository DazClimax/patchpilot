...
services:
  patchpilot:
    image: ghcr.io/dazclimax/patchpilot:v1.6.4
...
```bash
curl -fsSL https://raw.githubusercontent.com/DazClimax/patchpilot/v1.6.4/setup.sh | sudo PORT=443 AGENT_PORT=8050 bash
```
